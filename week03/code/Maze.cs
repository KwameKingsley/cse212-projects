...
public class Maze
{
    ...
    /// <summary>
    /// Check to see if you can move left (index 0).
    /// </summary>
    ...
    /// <summary>
    /// Check to see if you can move right (index 1).
    /// </summary>
    ...
    /// <summary>
    /// Check to see if you can move up (index 2).
    /// </summary>
    public void MoveUp()
    {
    ...
    /// <summary>
    /// Check to see if you can move down (index 3).
    /// </summary>
